...
%% ETSC, 1995: recommendations for speed limits. How to enforce? 
...
%% countermeasures (shinar, 2017)

% 4. What influences the speed in urban environments? Relate to speed management policies in general.

%% WRI

%% Balance between speed, flow and density. (See Bastos classes and my TCC)

% 5. Speeding as a risk behavior problem. (shinar 2007, elvik et al 2009)

%% How drivers percepts speeding?

%% Drivers choice of speed

% 6. How to collect speeding data: speeding tickets, speed traps (fixed or mobile), researches that considers the accidents reports, behavioral studies, case studies with a local perspective.
