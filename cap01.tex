...
% Safe System Approach (ITF)

%% It comes from a need of a fundamental shift in road safety programmes

%% Traditional road safety interventions have proven their effectiveness and need to be maintained and intensified. 

%% In a Safe System framework, interventions that still leaves open the opportunity for fatality are not enough

%% Therefore, it is necessary to close this gap.

% Main features of Safe System approaches:

%% Aim to develop road systems that are better able to accommodate human error. 

%% Better management of crash forces

%% Rely on economic analysis to understand the scale of the trauma problem

%% Safety management integrating all key government agencies and society.

%% Embrace the ethos of "shared responsibility"

%% The road user is not be relied upon to behave safely. (the weakest link)

% The Safety System approach and societal values in three main areas to be considered.

%% The significance of economic development: transport infrastructure and mobility are important sectors of economic development. Usually, safety has become a subsidiary to mobility. Safe System aims to transform the mobility into a function of safety, where the system designers become one of the responsible for the safety of users in the road system.

%% Sustaining human and environmental health: Economic development cannot come at the cost of death and serious injuries. Public health must come first.

%% The individual as consumer: Safe System recognizes the limits to which individual behaviors can be regulated. The individual needs to recognize the safe constraints of the system and demand safer services and products. Citizens demands and expects safety improvements. (safety culture)

% Infrastructure, speed and physical vulnerability

%% The human body's tolerance is at the center of the Safe System approach.

%% Speed limits must be compatible to this tolerance. 

%% Intersections must reduce impact speeds and number of conflicts, improving the interaction between users.

%% Intelligent infrastructure and vehicles

% Implementation of the Safe System approach

%% This system considers the interaction of multiple components of the transport system, rather than considering individual countermeasures in relative isolation.

%% Constant measure of road safety performance

%% Integration with road safety and another societal goals. (economy, environment, etc.)

% Larsson, Tingvall

%% Safe Systems treats human error as a systems failure, not an individual error. Human error as a consequence of the road system, not as cause of road crashes. 

%% Acceptance that crashes will continue to occur, focus on prevention of serious injuries and deaths. 

%% Consider the fragility of the human body

%% The design of the road transport system should guide the road user to a safe behavior. Human errors cannot be fully eradicated. Infrastructure and vehicles must mitigate the consequence of these errors. 

%% Importance of understanding and integrating road user behavior, traffic environment, speed management and vehicle system in road safety performance. 
