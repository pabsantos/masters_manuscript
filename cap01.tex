...
\begin{enumerate}
    ...
    \item Identify practical solutions to mitigate speeding behavior through urban planning practices, based on the results - Section \autoref{sec:sp_manag}.
\end{enumerate}
...
\begin{table}
    ...
    \begin{tabular}{lrr}
        \hline
        \multicolumn{1}{c}{\textbf{Variable}} & \multicolumn{1}{c}{\textbf{W}} & \multicolumn{1}{c}{\textbf{$p$-value}} \\
        \hline
        AVI  & 13.0 & 0.00217* \\
        PD   & 40.0 & 0.29734 \\
        SND  & 29.0 & 0.06983 \\
...
To better explore the incluence of the proportion of arterial roads on speeding behavior, it was decided to ...
