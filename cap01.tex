...
% 1. Table with all variables: group & variable & abbreviation & unit & expected correlation to speeding

% 2. TAZ shape (general info, source)

% 3. Independent variables calc (how each one was made)
