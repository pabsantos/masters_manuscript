...
%% Factors that influence speeding  (shinar, who, elvik, nshta) - try to split into vehicle, environment and behavior
...
%% Balance between speed, flow and density. (See Bastos classes and my TCC, HCM?)
...
%% Connect to next sector: built environments
...
% 7. Countermeasures (shinar, 2017, traffic calming - WRI, mohan)

%% Engineering treatments (who, 2008)
